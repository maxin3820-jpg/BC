...
const PackCard = ({ pack }) => {
  ...
  const whatsappMsg = encodeURIComponent(
    `Hi! I'm interested in the pack: "${pack.title}" — priced at ${symbol}${pack.price}. Can you help me get it?`
  )
  ...
  return (
    <div className="pack-card">
      ...
      <div className="pack-thumb">
        ...
        {discount && (
          <span className="pack-discount-badge">-{discount}%</span>
        )}
      </div>
        ...
        <div className="pack-includes">
          ...
          <ul>
            {pack.items.map((item, i) => (
              <li key={i}>
                <span className="pack-check">✓</span> {item}
              </li>
            ))}
          </ul>
        </div>
